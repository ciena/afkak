...
from ._util import calc_crc32c, decode_varint, encode_varint, size_of_varint
from .codec import gzip_decode, gzip_encode, has_gzip, has_snappy, snappy_decode, snappy_encode
from .common import CorruptRecordException, UnsupportedCodecError
...
class DefaultRecordBatchBuilder(DefaultRecordBase):
    ...
    def __init__(self, magic, compression_type, is_transactional, producer_id, producer_epoch, base_sequence):
        assert magic >= 2
        self._magic = magic
